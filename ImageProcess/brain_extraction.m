function [brain, dicomImgs, startI, endI, fnamelis] = brain_extraction(DcmDir, DcmList)
...
%     DcmList = ImgNew;
    ...
    [adjustImg, normalizedImg,dicomImgs, bone,fnamelis,~] = normalization(DcmDir, DcmList, 1, length(DcmList));
