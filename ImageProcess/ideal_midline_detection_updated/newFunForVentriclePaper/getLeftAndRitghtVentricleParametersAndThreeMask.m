function [midline_x, midline_y, fan_angle, ...\
          vthree_mask, vleft, vright, v_all, mask_midline_draw, ...\ 
    actualmidlineImgMarked, actualmidlineImgMarked_withTitle, rev] ...\
    = getLeftAndRitghtVentricleParametersAndThreeMask(levelsetImg_3D)
...
ori_2d_contourIncludingwindow = uint8(mask_lookingOriImg_contour(49:816,217:984));
