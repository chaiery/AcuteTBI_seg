function selectedImageList = test_ideal_midline_updated(inputDir, outputDir)
...
for i_img = 1: lenList
    ...
    if rev == 0
        ...
        if rev ~= 0
            %%%% adding Negar's closing Fracture to Qi's code
