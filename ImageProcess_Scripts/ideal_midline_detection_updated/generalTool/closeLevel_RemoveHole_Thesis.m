...
imageDirRoot = 'C:\3547679_rotate - 5 degree\';
imageDirRootSave = 'C:\3547679_rotate - 5 degree_fractureDetection\';
...
fprintf( 'i = %d,  file: %s  ',cur_patient,  dirList(cur_patient).name);
if sum_region == 2
    fprintf('bone is ok.\n'); 
else
    fprintf('crash level is %d. \n', sum_region-2);
end
