function [ rotate_angle,choosing, outerBw, innerBw, rev ] =  ...
                    getRotatedAngleByApproCenter( bwSkullBone, center)
...
[rotate_angle1, dis_vec1, best_j1]=rota_searchByApproCenter(bw1, center);
[rotate_angle2, dis_vec2, best_j2]=rota_searchByApproCenter(bw2, center);
...
function [centered_img,rev] = centeredImgWithMassCenter(seg_skull, center)
...
function [rotate_angle, dis_vec, best_j]=rota_searchByApproCenter(seg_skull, center)

rev = 0;

% figure;imshow(coord_img)
[centered_img,rev] = centeredImgWithMassCenter(seg_skull, center);
if (rev~= 0 )
   return; 
end
